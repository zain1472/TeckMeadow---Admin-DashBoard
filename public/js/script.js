...
function appendMessage(message, me) {
  ...
  var chat = $("#messages");
  chat.getNiceScroll(0).doScrollTop(chat.get(0).scrollHeight + 400, -1);
  ...
  \*****************************/
      ...
      /***/ function (module, exports, __webpack_require__) {
          ...
          (function ($) {
            ...
            $(
              ".navigation .navigation-menu-body .navigation-menu-group ul li a.active"
            )
              .closest("ul")
              .parent("li")
              .addClass("open")
            ...
            $(
              ...
              .addClass("open");
            $(
              '.navigation .navigation-menu-tab [data-nav-target="#' +
              $(
                ".navigation .navigation-menu-body .navigation-menu-group ul li a.active"
              )
                .closest("div")
            ...
            wind_.on("load", function () {
              setTimeout(function () {
                ...
                $(
                  ".navigation .navigation-menu-body ul li.open>a>.sub-menu-arrow"
                )
                  .removeClass("ti-plus")
                  .addClass("ti-minus")
                  .addClass("rotate-in");
            ...
            $(".navigation .navigation-header").append(
              c.addClass("navigation-logo").removeClass("header-logo")
            );
            $(document).on("click", ".navigation-toggler a", function () {
              if (wind_.width() < 1200) {
                ...
                if (
                  !body_.hasClass("navigation-toggle-one") &&
                  !body_.hasClass("navigation-toggle-two")
                ) {
            ...
            $(document).on("click", "*", function (e) {
              if (
                !$(e.target).is(
                  $(".navigation, .navigation *, .navigation-toggler *")
                ) &&
                body_.hasClass("navigation-toggle-one")
              ) {
                body_.removeClass("navigation-show");
            ...
            $(document).on("click", ".navigation ul li a", function () {
              ...
              if ($this.next("ul").length) {
                ...
                if (
                  !body_.hasClass("horizontal-side-menu") &&
                  wind_.width() >= 1200
                ) {
            ...
            if (wind_.width() >= 992) {
              ...
              if (chat_messages.length) {
                ...
                chat_messages
                  .getNiceScroll(0)
                  .doScrollTop(chat_messages.get(0).scrollHeight, -1);
              }
            }

            if (
              !body_.hasClass("small-navigation") &&
              !body_.hasClass("horizontal-navigation") &&
              wind_.width() >= 992
            ) {
